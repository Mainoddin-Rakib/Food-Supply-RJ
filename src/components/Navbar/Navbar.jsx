...
const Navbar = () => {
    ...
    return (
        <div className="navbar flex justify-between items-center">
            ...
            <ul className='navbar-menu flex list-none gap-[20px]  text-[#49557e] font-semibold cursor-pointer '>
            ...
            <div className="navbar-right flex items-center gap-[40px] ">
                ...
                <div className="bg-transparent
                   ...
                   hover:bg-[#fff4f2]
                    hover:text-black transition duration-200 rounded-[50px] cursor-pointer">
                    Sign-In
                </div>
